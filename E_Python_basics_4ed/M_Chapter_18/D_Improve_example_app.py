"""Review Exercises 18.2"""

# The GUI application for rotating PDF pages in this section has a
...
# if the user quits during rotation degrees selection, ask again.

while rotation_degrees == None:
    rotation_degrees = gui.buttonbox(
        msg="Rotate pdf pages clockwise how many degrees?",
        choices=choices
    )
